...
extern void *mono_aot_module_toDelete_BlueToothClassic_iOS_info;
...
extern void *mono_aot_module_toDelete_BlueToothClassic_info;

void xamarin_register_modules ()
{
	mono_aot_register_module (mono_aot_module_toDelete_BlueToothClassic_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_toDelete_BlueToothClassic_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "toDelete_BlueToothClassic.iOS.exe";
